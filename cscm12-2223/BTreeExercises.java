...
class BTree<T> {
  ...
  {
    Set<BTree<T>> above = new TreeSet<BTree<T>>();
    Set<BTree<T>> onTheLeft = new TreeSet<BTree<T>>();
  ...
  // been detected
  protected int checkCycleSharingInner(Set<BTree<T>> above,
      Set<BTree<T>> onTheLeft)
  {
